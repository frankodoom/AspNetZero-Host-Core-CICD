...
namespace tgtDemo.Web.Public.Startup
{
    ...
    public class tgtDemoWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public tgtDemoWebFrontEndModule(IHostingEnvironment env, tgtDemoEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(tgtDemoWebFrontEndModule).GetAssembly());
        }
    }
}
