...
using tgtDemo.Authorization.Accounts.Dto;
using tgtDemo.Authorization.Users;
using tgtDemo.MultiTenancy;
using tgtDemo.Web.Authentication.JwtBearer;
using tgtDemo.Web.Authentication.TwoFactor;
using tgtDemo.Web.Models.TokenAuth;
using tgtDemo.Authorization.Impersonation;
using tgtDemo.Identity;
using tgtDemo.Net.Sms;
using tgtDemo.Notifications;
using tgtDemo.Web.Authentication.External;

namespace tgtDemo.Web.Controllers
{
    [Route("api/[controller]/[action]")]
    public class TokenAuthController : tgtDemoControllerBase
    {
