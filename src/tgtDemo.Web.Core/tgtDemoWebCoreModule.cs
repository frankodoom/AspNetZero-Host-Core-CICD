...
using tgtDemo.Web.Configuration;

namespace tgtDemo.Web
{
    [DependsOn(
        typeof(tgtDemoApplicationModule),
        typeof(tgtDemoEntityFrameworkCoreModule),
    ...
    public class tgtDemoWebCoreModule : AbpModule
    {
        private readonly IHostingEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public tgtDemoWebCoreModule(IHostingEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(tgtDemoApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(tgtDemoWebCoreModule).GetAssembly());
        }
        ...
        private void SetAppFolders()
        {
            ...
            {
                var currentAssemblyDirectoryPath = typeof(tgtDemoWebCoreModule).GetAssembly().GetDirectoryPathOrNull();
