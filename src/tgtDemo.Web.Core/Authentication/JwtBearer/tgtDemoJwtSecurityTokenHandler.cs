...
namespace tgtDemo.Web.Authentication.JwtBearer
{
    public class tgtDemoJwtSecurityTokenHandler : ISecurityTokenValidator
    {
        private readonly JwtSecurityTokenHandler _tokenHandler;

        public tgtDemoJwtSecurityTokenHandler()
        {
