...
namespace tgtDemo.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : tgtDemoServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("tgtDemo", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
