...
namespace tgtDemo.MultiTenancy.Payments.Stripe
{
    //TODO: We may use a retry mechanism using the Poly library.

    public class StripeGatewayManager : tgtDemoServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "tgtDemo";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + tgtDemoConsts.Currency;
        }
