...
using tgtDemo.Core.Base;
using tgtDemo.Core.Extensions;
using tgtDemo.Dto;
using tgtDemo.Types;

namespace tgtDemo.Queries
{
    public class OrganizationUnitQuery : tgtDemoQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
