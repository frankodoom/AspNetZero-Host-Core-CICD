...
{
    [DependsOn(
        typeof(tgtDemoWebCoreModule)
    )]
    public class tgtDemoWebHostModule : AbpModule
    {
        private readonly IHostingEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public tgtDemoWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(tgtDemoWebHostModule).GetAssembly());
        }
