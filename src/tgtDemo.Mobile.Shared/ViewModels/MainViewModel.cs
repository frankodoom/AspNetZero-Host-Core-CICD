...
using MvvmHelpers;
using tgtDemo.Authorization.Users.Profile;
using tgtDemo.Authorization.Users.Profile.Dto;
using tgtDemo.Commands;
...
using tgtDemo.Controls;
using tgtDemo.Dto;
using tgtDemo.Extensions;
using tgtDemo.Localization;
using tgtDemo.UI;
using tgtDemo.UI.Assets;
using tgtDemo.Views;
using DependencyResolver = tgtDemo.Core.Dependency.DependencyResolver;

namespace tgtDemo.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "tgtDemo";
