...
using tgtDemo.DemoUiComponents.Dto;

namespace tgtDemo.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : tgtDemoAppServiceBase, IDemoUiComponentsAppService
    {
