...
using tgtDemo.Editions;
using tgtDemo.Sessions.Dto;
using tgtDemo.UiCustomization;

namespace tgtDemo.Sessions
{
    public class SessionAppService : tgtDemoAppServiceBase, ISessionAppService
    {
        ...
        public async Task<GetCurrentLoginInformationsOutput> GetCurrentLoginInformations()
        {
            var output = new GetCurrentLoginInformationsOutput
            {
                Application = new ApplicationInfoDto
                {
                    ...
                    Currency = tgtDemoConsts.Currency,
                    CurrencySign = tgtDemoConsts.CurrencySign,
                    AllowTenantsToChangeEmailSettings = tgtDemoConsts.AllowTenantsToChangeEmailSettings
                }
            };
