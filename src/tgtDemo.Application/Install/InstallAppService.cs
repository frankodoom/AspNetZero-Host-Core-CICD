...
using tgtDemo.Migrations.Seed;
using tgtDemo.Migrations.Seed.Host;
...
namespace tgtDemo.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : tgtDemoAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<tgtDemoDbContext> _migrator;
        ...
        private string GetConnectionString()
        {
            ...
            return connectionStrings.Property(tgtDemoConsts.ConnectionStringName).Value.ToString();
        }
