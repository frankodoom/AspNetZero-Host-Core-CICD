...
using tgtDemo.Auditing.Exporting;
using tgtDemo.Authorization;
using tgtDemo.Authorization.Users;
using tgtDemo.Dto;
using tgtDemo.EntityHistory;
using EntityHistoryHelper = tgtDemo.EntityHistory.EntityHistoryHelper;

namespace tgtDemo.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : tgtDemoAppServiceBase, IAuditLogAppService
    {
