...
using tgtDemo.Authentication.TwoFactor.Google;
using tgtDemo.Authorization.Users.Dto;
using tgtDemo.Authorization.Users.Profile.Cache;
using tgtDemo.Authorization.Users.Profile.Dto;
using tgtDemo.Friendships;
using tgtDemo.Gdpr;
using tgtDemo.Identity;
using tgtDemo.Net.Sms;
using tgtDemo.Security;
using tgtDemo.Storage;
using tgtDemo.Timing;

namespace tgtDemo.Authorization.Users.Profile
{
    [AbpAuthorize]
    public class ProfileAppService : tgtDemoAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("tgtDemo",
        ...
        public async Task<UpdateGoogleAuthenticatorKeyOutput> UpdateGoogleAuthenticatorKey()
        {
            ...
            {
                QrCodeSetupImageUrl = _googleTwoFactorAuthenticateService.GenerateSetupCode("tgtDemo",
                    user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300).QrCodeSetupImageUrl
            };
        }
